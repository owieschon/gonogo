...
```
task_satisfaction 100%  scope_discipline 95%  claim_verification 86%  goal_alignment 95%  overall verdict 95%  core 10/12 FAIL  drift 12/12  injection 3/3  spread 0.43  21 live runs · 7 fixtures × k=3 · cost $2.40
```
